...
class JogoDaSabedoriaApp:
    ...
    def tela_iniciar_jogo(self):
        ...
        label.image = img_bg
        tk.Label(root, text='Qual é o planeta mais próximo do Sol?', font=("Georgia", 24, "bold"), fg = "#f0f0f0", image = img_bg, compound='center').place(x = 41, y = 71)
        ...
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 41, y = 452, anchor = "nw")
        ...
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 756, y = 452, anchor = "nw")
       ...
       ## Botão Alternativa C
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 41, y = 640, anchor = "nw")
        ...
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 756, y = 640, anchor = "nw")
        ...
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 401, y = 828, anchor = "nw")
        ...
        tk.Button(
            ...
            borderwidth = 0,
            highlightthickness = 0,
            command = self.tela_aluno).place(x = 15, y = 930, height = 56, width = 56, anchor = "nw")
        ## Texto Botão Voltar
